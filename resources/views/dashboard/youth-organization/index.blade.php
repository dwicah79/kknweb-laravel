...
@section('konten')
    <x-breadcrumb :links="[
        ...
        ['name' => 'STRUKTUR PEMUDA', 'url' => '#'],
    ]" />
    <x-header-component title="STRUKTUR PEMUDA" route="youth-organization.create" />

    <div class="bg-white shadow-md sm:rounded-lg overflow-hidden p-6">
        <div class="w-full flex justify-end">
            <div class="w-full md:w-1/2">
                <form class="flex items-center justify-end" method="GET" action="{{ route('youth-organization.index') }}">
