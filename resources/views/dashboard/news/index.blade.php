...
@section('konten')
    ...
    <div class="w-full flex justify-between items-center bg-gradient-primmary px-5 py-5 mb-2">
        <h1 class="font-extrabold uppercase text-white text-xl">BERITA</h1>
        <a href="{{ route('news.create') }}" class="bg-white rounded-lg w-fit whitespace-nowrap p-2 hover:bg-slate-100"><i
                        ...
                        <tr class="bg-white hover:bg-gray-100">
                            ...
                            <td class="px-4 py-4 text-center">
                                <div class="flex justify-center space-x-2">
                                    <a href="{{ route('news.edit', $item->id) }}" class="text-blue-300 hover:text-blue-400">
                                        <i class="fa-solid fa-eye"></i>
                                        </svg>
                                    </a>
                                    <form id="delete-form-{{ $item->id }}"
                                        action="{{ route('news.destroy', $item->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
